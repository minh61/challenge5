...
<body>
    <nav class="navbar navbar-expand-lg bg-success navbar-light ">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a class="nav-link" href="student_page.php"><strong>Trang chủ sinh viên</strong></a></li>
        ...
        <center>
            <br><br><br>
        <p style="font-size: 35px;">Chào mừng <strong><?php echo $_SESSION['fullname'] ?></strong> đến trang chủ sinh viên! </p>
        </center>
</body>
</html>
